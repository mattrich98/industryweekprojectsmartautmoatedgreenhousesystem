...
<li>Add the visual imagery that correspond with number changes in javaScript - Part 1: Finish the buttons that chagne with temp bar, do the diagram last, it will be done with postion absolute and positioning over the picture that emulates a similar feel to windows, etc.</li>
